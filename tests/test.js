...
test_jar.setCookies("b=3;domain=test2.com;path=/");
assert.equal(String(test_jar.getCookies(CookieAccessInfo("test2.com","/"))), "b=3; domain=test2.com; path=/");
